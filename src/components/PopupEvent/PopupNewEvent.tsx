...
const PopupNewEvent = () => {
  const { clickedDay, setClickedDay, currentFilter } = useDatePickerStore();
  ...
  return (
    <section
      ...
      className={`${
        ...
        currentFilter === 2
          ...
          : currentFilter === 1
          ? "top-16"
          : "left-0 translate-y-[20%] translate-x-[40%]"
    ...
    >
      ...
      <form
        onSubmit={(e) => {
          currentFilter === 2 ? handleSubmit(e) : sendata(e);
        }}
